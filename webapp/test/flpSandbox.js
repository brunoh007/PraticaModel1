		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "PraticaModel1",
									"targetURL": "#mentoriafiorikazpraticamodelbf-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mentoriafiorikazpraticamodelbf-display": {
								"semanticObject": "mentoriafiorikazpraticamodelbf",
								"action": "display",
								"description": "Atividade PraticaModel1",
								"title": "PraticaModel1",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mentoria.fiori.ka.zpraticamodelbf",
									"url": sap.ui.require.toUrl("mentoria/fiori/ka/zpraticamodelbf")
								}
							}
						}
					}
